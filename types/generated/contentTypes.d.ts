...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    bioShort: Attribute.RichText;
    BioMedium: Attribute.RichText;
    BioLong: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiActivityActivity extends Schema.CollectionType {
  ...
  attributes: {
    ...
    startLongitude: Attribute.Float;
    endLatitude: Attribute.Float;
    endLongitude: Attribute.Float;
    ...
    jumpCount: Attribute.Integer;
    achievement_count: Attribute.Integer;
    kudos_count: Attribute.Integer;
    comment_count: Attribute.Integer;
    athlete_count: Attribute.Integer;
    average_watts: Attribute.Integer;
...
export interface ApiCvCv extends Schema.SingleType {
  ...
  attributes: {
    ...
    smallBio: Attribute.Text;
    skills: Attribute.Component<'cv.skills', true>;
    education: Attribute.Component<'cv.education', true>;
    timeline: Attribute.Component<'cv.timeline', true>;
...
export interface ApiPhotoPhoto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::photo.photo', 'title'>;
...
export interface ApiThankThank extends Schema.SingleType {
